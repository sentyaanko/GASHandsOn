...
1. `AGHOHeroCharacterBase` に、以下を追加する
	* 関数
		* `BindASCInput()`
			...
			* [「GASDocumentatation」 の「4.6.2 Binding Input to the ASC」](https://github.com/tranek/GASDocumentation#concepts-ga-input) [(和訳)](https://github.com/sentyaanko/GASDocumentation/blob/lang-ja/README.jp.md#concepts-ga-input) を参照。
